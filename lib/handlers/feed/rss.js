    ...
    blog.entries(function(err, entries) {
      ...
      (function iter(i) {
        ...
        blog.entry(entry, function(err, entry) {
          ...
          i.e('guid', { isPermaLink: true }, uri.resolve(page.fullURL, utils.linkify(entry.slug, entry.publishedAt)));
          // TODO: support id in front matter
          /*
          if (post.locals.id) {
          ...
          */
          ...
          i.e('link', uri.resolve(page.fullURL, utils.linkify(entry.slug, entry.publishedAt)));
