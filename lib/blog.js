...
/**
 * List entries in the blog.
 *
 * The `entries` argument passed to the `callback` function will be an array of
 ...
 */
LocalPostsDatabase.prototype.entries = function(cb) {
  var self = this
    , dir = this._dir
    , tz = this._tz
    , recs = [];
  ...
  function scan(dir, pdirs, cb) {
    fs.readdir(dir, function(err, files) {
      ...
      (function iter(err) {
        ...
        rec = {};
        rec.path = path.relative(self._dir, file)
        //rec.context = {
